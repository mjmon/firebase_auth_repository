import 'package:firebase_auth_repository/src/firebase_auth_repository.dart';
  ...
  group('AuthenticationRepository', () {
    ...
    group('loginWithGoogle', () {
      ...
      test('calls signIn authentication, and signInWithCredential', () async {
        await firebaseAuthRepository.loginInWithGoogle();
        verify(googleSignIn.signIn()).called(1);
        verify(firebaseAuth.signInWithCredential(any)).called(1);
      });

      test('succeeds when signIn succeeds', () {
        expect(firebaseAuthRepository.loginInWithGoogle(), completes);
      });
      ...
      test('throws LogInWithGoogleFailure when exception occurs', () async {
        ...
        expect(
          firebaseAuthRepository.loginInWithGoogle(),
